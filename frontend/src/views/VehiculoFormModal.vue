<template>
  <BaseModal :show="show" @close="handleClose">
    ...
    <form @submit.prevent="handleSubmit" class="space-y-4">
      ...
      <div>
        <label class="block text-sm font-medium text-slate-300">Propietario</label>
      ...
      <div>
        <label class="block text-sm font-medium text-slate-300">VIN (Nro. Chasis)</label>
      ...
      <div>
        <label class="block text-sm font-medium text-slate-300">Año (Opcional)</label>
        <input 
      ...
      <div>
        <label class="block text-sm font-medium text-slate-300 mb-1">Foto del Vehículo</label>
        <div class="flex items-center justify-center w-full">
          <label class="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-slate-600 rounded-lg cursor-pointer bg-slate-800/40 hover:bg-slate-800/50 relative overflow-hidden">
            <div v-if="!form.foto_url" class="flex flex-col items-center justify-center pt-5 pb-6">
              ...
              <p class="mb-2 text-sm text-slate-400"><span class="font-semibold">Click para subir foto</span></p>
              <p class="text-xs text-slate-400">PNG, JPG (Automáticamente se asignará un auto HQ de prueba)</p>
            </div>
